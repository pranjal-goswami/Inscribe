<<<<<<< HEAD
<?php /* Smarty version 2.6.26, created on 2014-01-29 22:18:48
=======
<?php /* Smarty version 2.6.26, created on 2014-01-29 20:41:55
>>>>>>> be855790ded4c044c603645a68b055a33339d6f9
                        ...
                        <div class="col-md-12"> 
                            <div class="card">
                                <div class="card-heading image">
                                    ...
                                    <div class="card-heading-header">
                                        <a href="post.html"><h1>Design is not just what it looks like, It's how it feels</h1></a>
                                        <h3>  <span> Published today - <i class="icon-time muted"> </i> 08.34 AM</span> <span > <i class="icon-eye-open muted"> </i> 4 min read </span>  <span>  By <a href="profile.html"> Shaawn kan </a>  in  <i class="icon-bookmark muted"> </i>  <a href="topic.html"> Topic/Category </a></span> </h3>
                                    </div>
                                </div>
                                <hr>
                                <div class="card-body">
                            ...
                            <div class="tab-pane" id="topics">
                                ...
                                <div class="row push border-bottom">
                                    <div class="col-md-6">
                                        <div class="media border-right" >
                                            <a class="pull-left" href="#">
                                                <i class="icon-beaker icon-4x pull-left muted "></i>
                                            </a>
                                            <div class="media-body">
                                                <a href="#">  <h1 class="media-heading">5 minutes with us</h1></a>
                                    ...
                                    <div class="col-md-6" >
                                        <div class="media">
                                            <a class="pull-left" href="#">
                                                <i class="icon-quote-left icon-4x pull-left muted"></i>
                                            </a>
                                            <div class="media-body">
                                                <a href="#">   <h2 class="media-heading">Blog</h2></a>
                                ...
                                <div class="row border-bottom">
                                    <div class="col-md-6"  >
                                        <div class="media border-right" >
                                            <a class="pull-left" href="#">
                                                <i class="icon-circle-blank icon-4x pull-left muted"></i>
                                            </a>
                                            <div class="media-body">
                                                <a href="#">     <h2 class="media-heading">Company News</h2></a>
                                    ...
                                    <div class="col-md-6" >
                                        <div class="media" >
                                            <a class="pull-left" href="#">
                                                <i class="icon-building icon-4x pull-left muted"></i>
                                            </a>
                                            <div class="media-body">
                                                <a href="#">      <h2 class="media-heading">Development</h2></a>
